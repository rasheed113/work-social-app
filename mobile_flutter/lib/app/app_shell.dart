...
class _AppShellState extends State<AppShell> {
  ...
  @override void initState(){super.initState();index=widget.initialIndex;}
  Widget _page(){if(index==0)return const HomePage();if(index==1)return const FriendsPage();return Center(child:Text(labels[index]));}
